...
const Biography: React.FC<TaskProps> = ({
  id,
  index,
  icon,
  status,
      ...
      <article className="flex flex-col flex-grow gap-6 w-full h-full p-2 justify-start">
        <section className="flex flex-col gap-1 w-full items-center justify-center">
          ...
          <div className="flex flex-col justify-center w-full items-center gap-2">
            ...
            />
            <p>
              Hello there ! my name is Grégoire Drapeau and I'm a{' '}
              <b>software developer</b>.
            </p>
            <p>
              I'm <b>passionate</b> about technology and coding.
            </p>
            <p>
              Originating from France, I did a technology school and have
              multiple years of experiences.
            </p>
          </div>
        </section>
        <section className="flex flex-col gap-1 w-full items-center justify-center">
